...
Script Name: Fabric Hider
Author: William Dowling
Build Date: 15 November, 2016
Description: Create a rectangle that hides the fabric callout from the mockup file.
Build number: 1.0
...
Progress:
	...
	Version 1.002
		15 November, 2016
		Fixed batch function because variables were not being reset each time through the loop
			so the script was trying to access elements of a document that is no longer open. 
